...
from ._utils._format import InputError, _anndata_to_sce, _other_to_list, _strvec_none2ri, _typecheck
...
class scDesign3:
    ...
    def construct_data(
        ...
        # modify input
        corr_by, celltype, pseudotime, other_covariates = _other_to_list(corr_by,celltype, pseudotime, other_covariates)
